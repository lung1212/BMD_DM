...
#res4.e <- phenoscanner(snpquery=dat_radial$SNP[401:nrow(dat_radial)], pvalue = 5E-8, proxies = "EUR", r2 = 0.8, build = 37, catalogue = "eQTL")
#pheno.e<-rbind(res.e$results, res1.e$results, res2.e$results, res3.e$result, res4.e$results)
...
#res4.p <- phenoscanner(snpquery=dat_radial$SNP[401:nrow(dat_radial)], pvalue = 5E-8, proxies = "EUR", r2 = 0.8, build = 37, catalogue = "pQTL")
#pheno.p<-rbind(res.p$results, res1.p$results, res2.p$results, res3.p$result, res4.p$results)
